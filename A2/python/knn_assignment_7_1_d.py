...
#testPoint = pd.read_csv("/users/harishnk/datamining/A2/bankData_testpoint.csv")

testPoint = [40,10,84,2,2,0,0,0,1,1,1,0]
#testPoint = [46,21,193,2,8.10,0,0,0,0,0,0,0]

print testPoint

print clf.predict(testPoint)
